...
// ✅ Rol es TYPE, pero para runtime usamos ROL
...
export default function Sidebar({ user, isOpen, onClose }: SidebarProps) {
  ...
  const menuItems: Array<{
  ...
  }> = [
    {
      ...
      // ✅ todos los roles (runtime)
      roles: Object.values(ROL) as Rol[],
    },
    {
      href: "/historial",
      label: "Historial",
      ...
      roles: [ROL.admin, ROL.asistente, ROL.jefe, ROL.gerente, ROL.centro_de_control] as Rol[],
    },
    {
      href: "/mapa",
      label: "Mapa",
